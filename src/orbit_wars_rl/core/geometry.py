...
def predict_launch(
    ...
    the earliest time t where:
        ...
        distance(source, predicted_target_position(t)) - source.radius - target.radius == fleet_speed * t
    """
    ...
    def intercept_error(t: float) -> float:
        ...
        d = distance_xy(source.x, source.y, tx, ty) - source.radius - target.radius
